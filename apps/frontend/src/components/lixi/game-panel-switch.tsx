...
import { MathKingPanel } from "./math-king-panel";
...
export function GamePanelSwitch({ game, disabled, onEmit, gameState, playerId, room, onClose }: GamePanelSwitchProps) {
  ...
  if (game === "mathking") return <MathKingPanel disabled={disabled} onEmit={onEmit} gameState={gameState} playerId={playerId} room={room} onClose={onClose} />;
